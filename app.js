...
function render(arr)
{
    ...
    document.getElementById('displaybox').innerHTML=tmp;
}
function gainer(btn)
{
    ...
    document.getElementsByClassName('dikhao'+index)[0].innerText=price+"$";
    document.getElementsByClassName('dikhao'+index)[1].innerText=price+"$";
    console.log(prdArr);
    total();
